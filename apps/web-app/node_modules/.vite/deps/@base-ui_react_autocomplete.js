...
function AriaCombobox(props) {
	...
	*/
	...
	const popupProps = import_react.useMemo(() => mergeProps(FOCUSABLE_POPUP_PROPS, listNavigation.floating, dismiss.floating, role.floating), [
...
function AutocompleteRoot(props) {
	...
	function handleItemHighlighted(highlightedValue, eventDetails) {
		...
		if (enableInline) if (highlightedValue == null) setInlineInputValue("");
		else setInlineInputValue(stringifyAsLabel(highlightedValue, itemToStringValue));
...
function ComboboxItemVirtualizedIndex(props) {
	...
	const isItemEqualToValue = useStore(useComboboxRootContext(), selectors.isItemEqualToValue);
...
var ComboboxItem = /*#__PURE__*/ import_react.memo(/*#__PURE__*/ import_react.forwardRef(function ComboboxItem(componentProps, forwardedRef) {
	const virtualized = useStore(useComboboxRootContext(), selectors.virtualized);
...
//#endregion
export { index_parts_exports as Autocomplete };
