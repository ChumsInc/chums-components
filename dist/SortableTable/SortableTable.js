...
const SortableTable = ({ fields, data, currentSort, onChangeSort, keyField, size = '', rowClassName, renderRow, onSelectRow = utils_1.noop, selected = '', className = '', tfoot, children, ...rest }) => {
