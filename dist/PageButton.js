...
const CurrentPageButton = ({ page, label = null }) => {
    return (_jsx("li", { className: classNames('page-item active'), children: _jsx("span", { className: "page-link", children: label || page }) }));
};
const SelectablePageButton = ({ page, label = null, disabled = false, onClick }) => {
    ...
    return (_jsx("li", { className: classNames('page-item', { disabled: disabled }), children: _jsx("a", { href: "#", className: 'page-link', onClick: handleClick, children: label || page }) }));
};
