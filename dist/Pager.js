...
const Pager = ({ page, dataLength, rowsPerPage, filtered = false, onChangePage, onChangeRowsPerPage, }) => {
    ...
    return (_jsxs("div", { className: "row g-3", children: [_jsx("div", { className: "col-auto", children: _jsx(RowsPerPage, { onChange: onChangeRowsPerPage, value: page }) }), _jsx("div", { className: "col-auto", children: _jsx(Pagination, { pages: pages, page: page, onSelectPage: onChangePage, filtered: filtered }) })] }));
};
